...
namespace Kaskela.PluginBenchmarks.EarlyBound
{
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/fi/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("fi_SynchronizeQActionProcess")]
	public partial class fi_SynchronizeQActionProcessRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		
		public string QActionObjectType
		{
			get
			{
				if (this.Parameters.Contains("QActionObjectType"))
				{
					return ((string)(this.Parameters["QActionObjectType"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["QActionObjectType"] = value;
			}
		}
		
		public string DocumentDetailApplicationLookupField
		{
			get
			{
				if (this.Parameters.Contains("DocumentDetailApplicationLookupField"))
				{
					return ((string)(this.Parameters["DocumentDetailApplicationLookupField"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["DocumentDetailApplicationLookupField"] = value;
			}
		}
		
		public string ApplicationLogicalName
		{
			get
			{
				if (this.Parameters.Contains("ApplicationLogicalName"))
				{
					return ((string)(this.Parameters["ApplicationLogicalName"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["ApplicationLogicalName"] = value;
			}
		}
		...
		public fi_SynchronizeQActionProcessRequest()
		{
			this.RequestName = "fi_SynchronizeQActionProcess";
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/fi/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("fi_SynchronizeQActionProcess")]
	public partial class fi_SynchronizeQActionProcessResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public fi_SynchronizeQActionProcessResponse()
		{
		}
		...
		public bool RefreshRequired
		{
			get
			{
				if (this.Results.Contains("RefreshRequired"))
				{
					return ((bool)(this.Results["RefreshRequired"]));
				}
				else
				{
					return default(bool);
